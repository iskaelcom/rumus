...
const formulaSectionsId = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'konversi-berat',
        name: 'Konversi Satuan Berat',
        tagline: 'Mengubah nilai antar satuan berat metrik dan sistem Amerika.',
        formulas: [
          { label: 'Tangga Metrik', value: 'kg - hg - dag - g - dg - cg - mg' },
          { label: 'Turun 1 Tangga', value: '× 10' },
          { label: 'Naik 1 Tangga', value: '÷ 10' },
          { label: 'Ton ke kg', value: '1 ton = 1.000 kg' },
          { label: 'Kwintal ke kg', value: '1 kwintal = 100 kg' },
          { label: 'Ons & Pon (Indonesia)', value: '1 ons = 1 hg = 100 g | 1 pon = 5 ons = 500 g' },
          { label: 'Ons Amerika (oz)', value: '1 oz = 28,35 g' },
          { label: 'Pon Amerika (lb)', value: '1 lb = 16 oz ≈ 453,6 g' },
          { label: 'Ton Amerika', value: '1 ton (US) = 2.000 lb ≈ 907,2 kg' },
        ],
        variables: [
          'kg = kilogram',
          'hg = hektogram (ons)',
      ...
      {
        id: 'konversi-waktu',
        name: 'Konversi Satuan Waktu',
        tagline: 'Mengubah nilai antar satuan waktu dari abad hingga detik.',
        formulas: [
          { label: 'Hierarki Waktu', value: 'abad → dekade → tahun → bulan → minggu → hari → jam → menit → detik' },
          { label: '1 abad', value: '= 10 dekade = 100 tahun' },
          { label: '1 tahun', value: '= 12 bulan = 52 minggu = 365 hari' },
          { label: '1 bulan', value: '= 4 minggu = 30 hari (rata-rata)' },
          { label: '1 minggu', value: '= 7 hari' },
          { label: '1 hari', value: '= 24 jam = 1.440 menit = 86.400 detik' },
          { label: '1 jam', value: '= 60 menit = 3.600 detik' },
          { label: '1 menit', value: '= 60 detik' },
        ],
        variables: [
          'abad = 100 tahun',
          'dekade = 10 tahun',
          'tahun = 12 bulan',
          'bulan ≈ 30 hari (rata-rata)',
          'minggu = 7 hari',
          'hari = 24 jam',
          'jam = 60 menit',
          'menit = 60 detik',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        tagline: 'Converts values between metric and US weight units.',
        formulas: [
          { label: 'Metric Ladder', value: 'kg - hg - dag - g - dg - cg - mg' },
          { label: 'Down 1 Step', value: '× 10' },
          { label: 'Up 1 Step', value: '÷ 10' },
          { label: 'Ton to kg', value: '1 ton = 1,000 kg' },
          { label: 'Quintal to kg', value: '1 quintal = 100 kg' },
          { label: 'US Ounce (oz)', value: '1 oz = 28.35 g' },
          { label: 'US Pound (lb)', value: '1 lb = 16 oz ≈ 453.6 g' },
          { label: 'US Ton', value: '1 ton (US) = 2,000 lb ≈ 907.2 kg' },
        ],
        variables: [
          'kg = kilogram',
          'hg = hectogram',
      ...
      },
      {
        ...
        tagline: 'Converts values between time units from centuries to seconds.',
        formulas: [
          { label: 'Time Hierarchy', value: 'century → decade → year → month → week → day → hour → minute → second' },
          { label: '1 century', value: '= 10 decades = 100 years' },
          { label: '1 year', value: '= 12 months = 52 weeks = 365 days' },
          { label: '1 month', value: '= 4 weeks = 30 days (average)' },
          { label: '1 week', value: '= 7 days' },
          { label: '1 day', value: '= 24 hours = 1,440 minutes = 86,400 seconds' },
          { label: '1 hour', value: '= 60 minutes = 3,600 seconds' },
